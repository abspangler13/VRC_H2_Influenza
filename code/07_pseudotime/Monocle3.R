...
raw_cds <- cds
saveRDS(raw_cds, file = here::here("analysis","data_objects","07_pseudotime","raw_cds_seurat_clusters.rds"))

# Plot
pdf(file = here::here("analysis","plots","07_pseudotime","clusters.pdf"))
plot_cells(cds,
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters.rds"))
#cds <- readRDS(file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters.rds"))

custom_palette = c("#FF8C00","#FFD700","#9F79EE","#27408B","#FF4040","#8B2323","#BEBEBE")
names(custom_palette) <- c("AM1a_4","AM1a_6","AM2_0","RM_2","AM3_acute_1","AM3_chronic_3","IgM_5")

##change cluster labels and make them bigger
svg(file = here::here("analysis","plots","07_pseudotime","trajectory_graph.svg"))
plot_cells(cds,
           color_cells_by = 'Cluster.res0.4',
           label_groups_by_cluster = FALSE,
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_RM_2.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_IgM_5.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM1a_4.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM3_chronic_3.pdf"))
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","cds_pseudotime.rds"))
