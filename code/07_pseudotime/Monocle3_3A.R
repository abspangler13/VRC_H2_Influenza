...
seu.obj <- seu.obj %>% filter(vac_grp == "3A")
...
raw_cds <- cds
saveRDS(raw_cds, file = here::here("analysis","data_objects","07_pseudotime","raw_cds_seurat_clusters_3A.rds"))

# Plot
pdf(file = here::here("analysis","plots","07_pseudotime","clusters_3A.pdf"))
plot_cells(cds,
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters_3A.rds"))
#cds <- readRDS(file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters.rds"))

pdf(file = here::here("analysis","plots","07_pseudotime","trajectory_graph_3A.pdf"))
plot_cells(cds,
           color_cells_by = 'Cluster.res0.4',
           label_groups_by_cluster = FALSE,
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_RM_2_3A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_IgM_5_3A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM1a_4_3A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM3_chronic_3_3A.pdf"))
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","cds_pseudotime_3A.rds"))
