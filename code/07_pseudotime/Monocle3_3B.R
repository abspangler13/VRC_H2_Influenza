...
seu.obj <- seu.obj %>% filter(vac_grp == "3B")
...
raw_cds <- cds
saveRDS(raw_cds, file = here::here("analysis","data_objects","07_pseudotime","raw_cds_seurat_clusters_3B.rds"))

# Plot
pdf(file = here::here("analysis","plots","07_pseudotime","clusters_3B.pdf"))
plot_cells(cds,
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters_3B.rds"))
#cds <- readRDS(file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters.rds"))

pdf(file = here::here("analysis","plots","07_pseudotime","trajectory_graph_3B.pdf"))
plot_cells(cds,
           color_cells_by = 'Cluster.res0.4',
           label_groups_by_cluster = FALSE,
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_RM_2_3B.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_IgM_5_3B.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM1a_4_3B.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM3_chronic_3_3B.pdf"))
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","cds_pseudotime_3B.rds"))
