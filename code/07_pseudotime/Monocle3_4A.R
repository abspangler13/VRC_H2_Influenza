...
seu.obj <- seu.obj %>% filter(vac_grp == "4A")
...
raw_cds <- cds
saveRDS(raw_cds, file = here::here("analysis","data_objects","07_pseudotime","raw_cds_seurat_clusters_4A.rds"))

# Plot
pdf(file = here::here("analysis","plots","07_pseudotime","clusters_4A.pdf"))
plot_cells(cds,
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters_4A.rds"))
#cds <- readRDS(file = here::here("analysis","data_objects","07_pseudotime","learn_graph_cds_seurat_clusters.rds"))

pdf(file = here::here("analysis","plots","07_pseudotime","trajectory_graph_4A.pdf"))
plot_cells(cds,
           color_cells_by = 'Cluster.res0.4',
           label_groups_by_cluster = FALSE,
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_RM_2_4A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_IgM_5_4A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM1a_4_4A.pdf"))
...
pdf(file = here::here("analysis","plots","07_pseudotime","pseudotime_AM3_chronic_3_4A.pdf"))
...
saveRDS(cds, file = here::here("analysis","data_objects","07_pseudotime","cds_pseudotime_4A.rds"))
